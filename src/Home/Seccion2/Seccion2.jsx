          ...
          <div className="accordion accordion-flush"  id="accordionFlushExample">
            <div className="accordion-item" style={{backgroundColor:"rgba(255, 192, 203, 0.638)"}}>
                <h2 className="accordion-header" id="flush-headingOne">
                    <button className="accordion-button collapsed"style={{backgroundColor:"rgba(255, 192, 203, 0.638)",fontSize:"20px",letterSpacing:"5px",fontWeight:"bolder",border:"2px solid black"}} type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" aria-expanded="false" aria-controls="flush-collapseOne">
                      Ubicacion
                  </button>
                </h2>
            <div id="flush-collapseOne" className="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
              <div className="accordion-body" style={{borderLeft:"2px solid black",borderBottom:"2px solid black",borderRight:"2px solid black",backgroundColor:"rgba(243, 173, 184, 0.722)"}}> 
